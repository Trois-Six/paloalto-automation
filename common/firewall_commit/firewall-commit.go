...
func main() {
	...
	fw := &pango.Firewall{Client: pango.Client{
		...
		Password: password,
		ApiKey:   apiKey,
		// Logging:  pango.LogOp | pango.LogAction | pango.LogReceive | pango.LogCurlWithPersonalData | pango.LogOsxCurl | pango.LogQuery | pango.LogSend | pango.LogUid | pango.LogXpath,
