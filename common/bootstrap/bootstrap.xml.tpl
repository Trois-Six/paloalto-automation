...
<config version="10.1.0" urldb="paloaltonetworks" detail-version="10.1.0">
  <mgt-config>
    <users>
      <entry name="${fw_admin}">
        <phash>${fw_hashed_password}</phash>
        <permissions>
          <role-based>
    ...
    <entry name="localhost.localdomain">
      ...
      <deviceconfig>
        <system>
          ...
          <ntp-servers>
            <primary-ntp-server>
              <ntp-server-address>169.254.169.123</ntp-server-address>
              <authentication-type>
                <none/>
              </authentication-type>
            </primary-ntp-server>
        ...
        <setting>
          ...
          <wildfire>
            <public-cloud-server>eu.wildfire.paloaltonetworks.com</public-cloud-server>
          </wildfire>
        </setting>
      </deviceconfig>
      <vsys>
